...
public class Rural extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.documentation1){
            ...
            Uri uri=Uri.parse("http://vikaspedia.in/social-welfare/rural-poverty-alleviation-1/schemes/pradhan-mantri-gram-sadak-yojana");
            intent.setData(uri);
            ...
            data.add("Pradhan Mantri Gram Sadak Yojana");
            data.add("http://vikaspedia.in/social-welfare/rural-poverty-alleviation-1/schemes/pradhan-mantri-gram-sadak-yojana");
            ...
            Intent intent=new Intent();
            intent.setAction(Intent.ACTION_VIEW);
            Uri uri=Uri.parse("http://vikaspedia.in/social-welfare/rural-poverty-alleviation-1/schemes/indira-aawas-yojna");
            intent.setData(uri);
            startActivity(intent);
            ...
            ArrayList<String> data=new ArrayList<>();
            data.add("Pradhan Mantri Awaas Yojana (Gramin)");
            data.add("http://vikaspedia.in/social-welfare/rural-poverty-alleviation-1/schemes/indira-aawas-yojna");
            String data1= TextUtils.join("\n",data);
            Intent intent=new Intent();
            intent.setAction(Intent.ACTION_SEND);
            intent.setType("text/plain");
            ...
            Intent intent=new Intent();
            intent.setAction(Intent.ACTION_VIEW);
            Uri uri=Uri.parse("http://vikaspedia.in/social-welfare/rural-poverty-alleviation-1/schemes/sansad-adarsh-gram-yojana");
            intent.setData(uri);
            startActivity(intent);
        }
        else if(v.getId()==R.id.share3){
            ArrayList<String> data=new ArrayList<>();
            data.add("Sansad Adarsh Gram Yojana");
            data.add("http://vikaspedia.in/social-welfare/rural-poverty-alleviation-1/schemes/sansad-adarsh-gram-yojana");
            String data1= TextUtils.join("\n",data);
            Intent intent=new Intent();
            intent.setAction(Intent.ACTION_SEND);
            intent.setType("text/plain");
